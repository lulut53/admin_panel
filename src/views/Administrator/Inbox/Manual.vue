        ...
        <base-header class="pb-6" type="">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 d-inline-block mb-0">Manual</h6>
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                  <ol class="breadcrumb breadcrumb-links">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Inbox - Manual</li>
                  </ol>
              </nav>
            </div>
...
export default {
  ...
  data() {
    return {
      ...
      columnSearched: [
        ...
        { name: 'Target User', value: 'audience' },
        // { name: 'Dibuat pada', value: 'created_at' }
      ],
      currentColumnSearched: 'title',
      selectedRows: [],
  ...
  methods: {
    ...
    async getData() {
      ...
      let res = JSON.parse(JSON.stringify(await this.getManualNotifs(data)));
      if (res.name != 'Error') {
