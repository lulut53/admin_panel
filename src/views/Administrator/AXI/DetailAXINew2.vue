  ...
  methods: {
      ...
      this.provinsilist = [
        {
          ...
          label: this.lokasiIncluded.find((x) => x.type == "provinces")
            .attributes.nama,
        },
      ];
      ...
      this.kecamatanlist = [
        {
          ...
          label: this.lokasiIncluded.find((x) => x.type == "districts")
            .attributes.nama,
        },
      ];
      ...
      this.kelurahanlist = [
        {
          ...
          label: this.lokasiIncluded.find((x) => x.type == "villages")
            .attributes.nama,
        },
      ];
    ...
    async getData() {
      ...
      try {
        ...
        const fetchSAP =
          this.lokasi.attributes.desa_id.length < 7
            ? (await this.getKelurahanbyId(this.lokasi.attributes.desa_id),
              ...
              await this.getCabangById(this.axi.attributes.cabang_id),
    ...
    packData() {
      ...
      if (this.desaId.length > 0) {
        ...
        data.kecamatan = this.tempAlamat
          ? this.lokasiIncluded
            ? this.lokasiIncluded.find((x) => x.type == "districts").attributes
                .nama
            : "-"
          : "-";
        data.kota = this.tempAlamat
          ? this.lokasiIncluded
            ? this.lokasiIncluded.find((x) => x.type == "cities").attributes
                .nama
            : "-"
          : "-";
        data.provinsi = this.tempAlamat
          ? this.lokasiIncluded
            ? this.lokasiIncluded.find((x) => x.type == "provinces").attributes
                .nama
            : "-"
          : "-";
      ...
      data.status_perkawinan =
        this.tempProfile.attributes.status_perkawinan == "0"
          ? "Single"
          : this.tempProfile.attributes.status_perkawinan == "1"
          ? "Married"
          : this.tempProfile.attributes.status_perkawinan == "2"
          ? "Widowed"
          : this.tempProfile.attributes.status_perkawinan == "3"
          ? "Divorced"
          : this.tempProfile.attributes.status_perkawinan == "4"
          ? "Separated"
          : "-";
    ...
    async simpanData() {
      ...
      if (valid) {
        ...
        try {
          ...
          swal("Sukses", "Berhasil mengganti data", "success").then(
            function () {
              that.getData();
            }
          );
    ...
    async simpanFoto() {
      ...
      if (
        ...
        try {
          ...
          swal("Sukses", "Berhasil mengganti foto", "success").then(
            function () {
              that.getData();
            }
          );
    ...
    resetPass() {
      ...
      swal({
        ...
        if (result.value) {
          ...
          let res = await that.newResetPassword(
            this.axi.attributes.nomor_axi_id
          );
          console.log(res);
