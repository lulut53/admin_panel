  ...
  <div>
              ...
              <div key="2" v-if="isShow">
                <div class="card-body">
                  <div class="card">
                    ...
                    <div class="card-body">
                      <div class="row">
                        <div class="col-4">Status AXI</div>
                        <div class="col-8">: {{ axiData.status_registrasi }}</div>
                      </div>
                      <div class="row">
                        <div class="col-4">Nomor BP</div>
                        <div class="col-8">: {{ axiData.bp_number }}</div>
                      </div>
                      <div class="row">
                        <div class="col-4">Jenis AXI</div>
                        <div class="col-8">: {{ axiData.jenis_axi }}</div>
                      </div>
                      <div class="row">
                        <div class="col-4">Kategori AXI</div>
                        <div class="col-8">
                          :
                          {{
                            axiData.tipe_npwp == "1"
                      ...
                      <div class="row" v-if="this.detailRegAxi.jenis_axi == '3'">
                        <div class="col-4">Jenis Karyawan</div>
                        <div class="col-8">: {{ axiData.jenis_karyawan }}</div>
                      </div>

                      <div class="row" v-if="this.detailRegAxi.tipe_npwp == '2'">
                        <div class="col-4">Jenis Badan Usaha</div>
                        <div class="col-8">:
                          {{
                            axiData.legal_form == "01"
                            ? "Foreign Company"
                            : axiData.legal_form == "CV"
                            ? "Commanditaire vennootschap"
                            : axiData.legal_form == "KP"
                            ? "Koperasi"
                            : axiData.legal_form == "PT"
                            ? "Perseroan Terbatas"
                            : axiData.legal_form == "YS"
                            ? "Yayasan"
                            : axiData.legal_form == "03"
                            ? "Perorangan Dalam Negeri"
                            : axiData.legal_form == "FA"
                            ? "Firma"
                            : ""
                          }}</div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-8">
                          : {{ axiData.kode_cabang_daftar }}
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-4">Cabang Daftar</div>
                        <div class="col-8">
                          : {{ axiData.nama_cabang_daftar }}
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-4">Tanggal Daftar</div>
                        <div class="col-8">
                          : {{ axiData.tanggal_daftar | convertDate }}
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-4">Tanggal Approve</div>
                        <div class="col-8">
                          : {{ axiData.tanggal_approve | convertDate }}
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-4">Tanggal Masa Aktif</div>
                        <div class="col-8">
                          : {{ axiData.tanggal_masa_aktif | convertMonthYear }}
                        </div>
                      </div>
                      <div class="row">
                      ...
                      <div class="row">
                        ...
                        <div class="col-8">
                          : {{ axiData.tanggal_lahir | convertDate }}
                        </div>
                      </div>
                      <div class="row">
                      ...
                      <div class="row">
                        ...
                        <div class="col-8">: {{ axiData.agama }}</div>
                      </div>
                      <div class="row">
                      ...
                      <div class="row">
                        ...
                        <div class="col-8">: {{ detailRegAxi.nama_pasangan }}</div>
                      </div>
                      <div class="row">
                        <div class="col-4">No. KTP Pasangan</div>
                        <div class="col-8">: {{ detailRegAxi.no_ktp_pasangan }}</div>
                      </div>
                      <div class="row">
                      ...
                      <div class="row">
                        ...
                        <div class="col-8">
                          :
                          {{
                            axiData.status_npwp == 1 ? "Pribadi" : "Perusahaan"
                          }}
                        </div>
                      </div>
                      <div class="row">
                  ...
                  <div class="row">
                    <div>
                      <div class="images" v-viewer>
                        <template v-if="axiData.foto_profile">
                          <img
                            v-bind:src="axiData.foto_profile"
                            class="img-fluid"
                            alt
                            height="125"
                            v-if="axi.attributes"
              ...
              <transition name="fade" mode="out-in">
                ...
                <div key="2" v-if="isShow">
                  ...
                  <div class="row">
                    ...
                    <div class="col-6" v-if="point">
                      : Rp. {{ axiData.insentif_car }}
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-6">Insentive Mcy</div>
                    <div class="col-6" v-if="point">
                      : Rp. {{ axiData.insentif_mcy }}
                    </div>
                  </div>
                </div>
              </transition>
              ...
              <div key="2" v-if="isShow">
                <collapse :multiple-active="false">
                  <collapse-item name="1">
                    ...
                    <div>
                      <div class="images" v-viewer>
                        <template v-if="axiData.foto_ktp">
                          <img
                            v-bind:src="axiData.foto_ktp"
                            class="img-fluid"
                            alt=""
                            height="140"
                          />
                  ...
                  <collapse-item name="4">
                    <h5 slot="title" class="mb-0">Foto Selfie</h5>
                    <div>
                      <div class="images" v-viewer>
                        <template v-if="axiData.foto_selfie">
                          <img
                            v-bind:src="axiData.foto_selfie"
                            class="img-fluid"
                            alt=""
                            height="140"
                          />
                  ...
                  <collapse-item name="2">
                    ...
                    <div>
                      <div class="images" v-viewer>
                        <template v-if="axiData.foto_npwp">
                          <img
                            v-bind:src="axiData.foto_npwp"
                            class="img-fluid"
                            alt=""
                            height="140"
                          />
                  ...
                  <collapse-item name="3">
                    ...
                    <div>
                      <div class="images" v-viewer>
                        <template v-if="axiData.foto_rekening">
                          <img
                            v-bind:src="axiData.foto_rekening"
                            class="img-fluid"
                            alt=""
                            height="140"
                          />
      ...
      <el-form @submit.prevent="simpanData">
        <el-dialog :visible.sync="showModal" title="Ubah Data" v-if="isShow">
            ...
            <div class="form-group">
              ...
              <div class="row mb-4">
                ...
                <div class="col-md-8">
                  ...
                  >
                    <el-select
                      v-model="jenisAxiValue"
                      filterable
                      remote
                      reserve-keyword
                      placeholder="Ketik Jenis AXI"
                      :loading="loading"
                      @change="setJenisAXI()"
                    >
                      <el-option
                        v-for="item in optionsJenisAxi"
                        :key="item.value"
                        :value="item.value"
                        :label="item.label"
                      ></el-option>
                ...
                <div class="col-md-8">
                  ...
                  >
                    <select
                      ...
                      name="tipe_npwp"
                      id="tipe_npwp"
                      v-model="kategoriAxiValue"
                      :disabled="jenisAxiValue == 3"
                    >
              ...
              <div class="row mb-4" v-if="jenisAxiValue === 3">
                <label
                  for="jenis_karyawan"
                  class="col-md-4 col-form-label form-control-label"
                  >Jenis Karyawan</label
                >
                <div class="col-md-8">
                  <ValidationProvider
                    name="Jenis Karyawan"
                  ...
                  >
                    ...
                    >
                      <el-option
                        v-for="item in listJenisKaryawan"
                        :key="item.value"
                        :value="item.value"
                        :label="item.label"
                      ></el-option>
              ...
              <div class="row mb-4" v-if="kategoriAxiValue !== '1'">
                <label
                  for="legal_form"
                  class="col-md-4 col-form-label form-control-label"
                  >Jenis Badan Usaha</label
                >
                <div class="col-md-8">
                  <ValidationProvider
                ...
                <div class="col-md-8">
                  ...
                  >
                    <el-input
                      id="nama_ibu_kandung"
                      type="text"
                      v-model="axiData.nama_ibu_kandung"
                      required
                    ></el-input>
                    <span class="error">{{ errors[0] }}</span>
                  </ValidationProvider>
                ...
                <div class="col-md-8">
                  ...
                  >
                    <el-input
                      id="no_ktp_pasangan"
                      type="text"
                      v-model="axiData.no_ktp_pasangan"
                      maxlength="16"
                      required
                    ></el-input>
          ...
          <template slot="footer" v-if="!isModalProcess">
            <el-form-item>
              <el-button type="secondary" @click="showModal = false"
                >Tutup</el-button
              >
    ...
    <el-form @submit.prevent="simpanPoint">
      ...
      >
        ...
        <template slot="footer" v-if="!isModalProcess">
          <el-form-item>
            <el-button type="secondary" @click="showModalPoint = false"
              >Tutup</el-button
            >
    ...
    <el-form @submit.prevent="simpanFoto">
      <el-dialog :visible.sync="showModalFoto" title="Ubah Foto" v-if="isShow">
        ...
        <template slot="footer" v-if="!isModalProcess">
          <el-form-item>
            <el-button type="secondary" @click="showModalFoto = false"
              >Tutup</el-button
            >
...
export default {
  ...
  computed: {
    ...
    axiId() {
      return this.$route.params.axi_id;
    }
  },
  methods: {
    ...mapActions("axi", [
    ...
    async areaRemoteMethod(query) {
      if (query !== "") {
        ...
        this.loading = false;
        this.optionsAreas = this.arealist.filter(item => {
    ...
    async setCabang(event) {
      // console.log(event);
      await this.getCabangByAreaId(event);
      this.cabanglist = this.cabang.map(item => {
        return {
          value: item.id,
          label: item.nama
        };
    ...
    setJenisAXI() {
      ...
      if (this.jenisAxiValue == "3") {
        this.kategoriAxiValue = "1";
      }
      if (this.jenisAxiValue == "2") {
        this.kategoriAxiValue = "2";
      }
    },
    ...
    async onFocusKota() {
      ...
      await this.getKota(this.provinsiValue);
    ...
    async onFocusKecamatan() {
      this.loading = true;

      await this.getKecamatan(this.kotaValue);
    ...
    async onFocusKelurahan() {
      this.loading = true;

      await this.getKelurahan(this.kecamatanValue);
    ...
    async assignDropdownSearch() {
      // console.log(this.detailRegAxi);
      // Dropdown
      this.kategoriAxiValue = this.axiData.tipe_npwp;
      this.optionsJenisAxi = this.jenis_axi.map(item => {
        return {
          value: item.id,
      ...
      this.jenisAxiValue =
        this.detailRegAxi.jenis_axi != ""
          ? parseInt(this.detailRegAxi.jenis_axi)
          : "";
      this.jenisKelaminValue =
        this.detailRegAxi.jenis_kelamin != ""
          ? parseInt(this.detailRegAxi.jenis_kelamin)
          : "";
      this.jenisKelaminList = this.jenis_kelamin.map(item => {
        return {
          value: item.id,
          label: item.deskripsi
        };
      ...
      this.agamaValue =
        this.detailRegAxi.agama != "" && this.detailRegAxi.agama != null
          ? parseInt(this.detailRegAxi.agama)
          : "";
      this.agamaList = this.agama.map(item => {
        return {
          value: item.id,
          label: item.deskripsi
        };
      });
      this.statusList = this.statusPernikahan.map(item => {
        return {
          value: item.id,
          label: item.deskripsi
        };
      ...
      this.statusValue =
        this.detailRegAxi.status_perkawinan != ""
          ? this.statusList.find(
              x => x.value == parseInt(this.detailRegAxi.status_perkawinan)
            ).value
          : "";
      // console.log(this.statusValue);
      // this.detailRegAxi.status_perkawinan != ""
      //   ? parseInt(this.detailRegAxi.status_perkawinan)
      //   : "";
      this.legalList = this.legalForm.map(item => {
        return {
          value: item.kode,
          label: item.deskripsi
        };
      ...
      this.legalFormValue = this.detailRegAxi.legal_form != ""
          ? this.detailRegAxi.legal_form
          : "";
      // console.log(
      //   this.detailRegAxi.jenis_kelamin,
      //   typeof this.detailRegAxi.agama,
      //   this.detailRegAxi.status_perkawinan
      // );
      ...
      // console.log(this.optionsBank);
      this.bankValue = this.detailRegAxi.bank_id;
      ...
      this.optionsAreas = this.arealist;
      this.cabanglist = this.cabang.map(item => {
        return {
          value: item.id,
          label: item.nama
      ...
      this.cabangValue =
        this.cabanglist != ""
          ? this.cabanglist.find(
              x => x.value == parseInt(this.detailRegAxi.cabang_id)
            ).value
          : "";
      this.optionsCabang = this.cabanglist;
      this.areaValue = this.detailRegAxi.area_id;
      ...
      // console.log(this.optionsProvinsi);
      this.provinsiValue = this.optionsProvinsi.find(
        x => x.label == this.axiData.provinsi
      ).value;
      ...
      this.optionsKota = this.kotalist;
      this.kotaValue = this.optionsKota.find(
        x => x.label == this.axiData.kota
      ).value;
      ...
      this.optionsKecamatan = this.kecamatanlist;
      this.kecamatanValue = this.optionsKecamatan.find(
        x => x.label == this.axiData.kecamatan
      ).value;
      // ---- Kelurahan ----
      await this.getKelurahan(this.kecamatanValue);
      this.kelurahanlist = this.desas.map(item => {
      ...
      this.optionsKelurahan = this.kelurahanlist;
      this.kelurahanValue = this.optionsKelurahan.find(
        x => x.label == this.axiData.kelurahan
      ).value;
      this.kode_pos = this.optionsKelurahan.find(
        x => x.label == this.axiData.kelurahan
      ).kodePos;
      // ====================================
      // jenis karyawa
      ...
      this.jenisKaryawanValue =
        this.detailRegAxi.jenis_karyawan != ""
          ? this.detailRegAxi.jenis_karyawan
          : "";
    },
    onChangeProvinsi() {
    ...
    async getData() {
      ...
      try {
        await Promise.all([
          ...
          this.getLegalForm(),
          this.getJenisAXI(),
          await this.getAxiDetailList(this.idAxiDetail),
          this.getJenisKaryawan(),
          // await this.getAxi("96737"),
          // this.getUser(
          ...
          //     .addresses.data[0].id
          // ),
          await this.getKelurahanbyId(this.detailRegAxi.desa_id),
          await this.getCabangByAreaId(this.detailRegAxi.area_id),
          await this.getCabangById(this.detailRegAxi.cabang_id),
          await this.getAreasById(this.cabangById.areaId)
        ]);
        // console.log(this.detailRegAxi.desa_id.length);
        const fetchSAP =
          this.detailRegAxi.desa_id.length < 7
        ...
        // console.log('axiData',this.axiData);
    ...
    packData() {
      // console.log(this.cabangById);
      // console.log(this.detailRegAxi);
      const data = {};
      data.jenis_karyawan =
        this.detailRegAxi.jenis_karyawan == "01"
        ? "REFO (Referral Order)"
        : this.detailRegAxi.jenis_karyawan == "02"
        ? "KBA (Konsultan Bisnis AXI)"
        : this.detailRegAxi.jenis_karyawan == "03"
        ? "CBD (Channeling Business Development)"
        : "" ;
      data.tanggal_daftar = this.detailRegAxi.tanggal_daftar;
      data.tanggal_approve = this.detailRegAxi.tanggal_approve;
      data.tanggal_masa_aktif = this.detailRegAxi.tanggal_masa_aktif;
      data.jenis_axi =
        this.detailRegAxi.jenis_axi == "1"
          ? "AXI Perorangan"
          : this.detailRegAxi.jenis_axi == "2"
          ? "AXI Pedagang"
          : "AXI Karyawan";
      data.legal_form =
        this.detailRegAxi.legal_form == null
          ? ""
          : this.detailRegAxi.legal_form;
      data.agama = parseInt(this.detailRegAxi.agama);
      data.status = this.detailRegAxi.status_registrasi;
      data.nama = this.detailRegAxi.nama;
      data.nomor_axi_id = this.axiId;
      data.tipe_npwp =
        this.detailRegAxi.tipe_npwp != "" ? this.detailRegAxi.tipe_npwp : "";
      data.agama =
        this.detailRegAxi.agama == "1"
          ? "Islam"
          : this.detailRegAxi.agama == "2"
          ? "Kristen"
          : this.detailRegAxi.agama == "3"
          ? "Katolik"
          : this.detailRegAxi.agama == "4"
          ? "Buddha"
          : this.detailRegAxi.agama == "5"
          ? "Kong Hu Chu"
          : this.detailRegAxi.agama == "6"
          ? "Hindu"
          : "Others";

      // console.log(typeof this.areaById, this.cabangById);

      if (this.areaById.length > 0) {
        data.kode_cabang =
          this.areaById != undefined ? this.areaById[0].id : "-";
        data.nama_cabang =
          this.areaById != undefined ? this.areaById[0].nama : "-";
        data.kode_cabang_daftar =
          this.cabangById != undefined ? this.cabangById.kode : "-";
        data.nama_cabang_daftar =
          this.cabangById != undefined ? this.cabangById.nama : "-";
      }
      data.no_ktp = this.detailRegAxi.no_ktp ? this.detailRegAxi.no_ktp : "-";
      data.kota_lahir = this.detailRegAxi.kota_lahir
        ? this.detailRegAxi.kota_lahir
        : "-";
      data.tanggal_lahir = this.detailRegAxi.tanggal_lahir
        ? moment(this.detailRegAxi.tanggal_lahir).format("YYYY-MM-DD")
        : "-";
      data.axi_id_reff = this.detailRegAxi.axi_id_reff
        ? this.detailRegAxi.axi_id_reff
        : "-";
      data.no_hp = this.detailRegAxi.no_hp ? this.detailRegAxi.no_hp : "-";
      data.email = this.detailRegAxi.email ? this.detailRegAxi.email : "-";
      data.jalan = this.detailRegAxi ? this.detailRegAxi.jalan : "-";
      data.rt = this.detailRegAxi ? this.detailRegAxi.rt : "-";
      data.rw = this.detailRegAxi ? this.detailRegAxi.rw : "-";
      data.desa_id = this.detailRegAxi ? this.detailRegAxi.desa_id : "-";

      if (this.desaId.length > 0) {
        data.kelurahan = this.desaId != "" ? this.desaId[0].nama : "-";
        data.kecamatan =
          this.kecamatanbyId != "" ? this.kecamatanbyId[0].nama : "-";
        data.kota = this.kotabyId != "" ? this.kotabyId[0].nama : "-";
        data.provinsi =
          this.provinsibyId != "" ? this.provinsibyId[0].nama : "-";
        data.kode_pos = this.desaId != "" ? this.desaId[0].kodePos : "-";
      }

      data.status_perkawinan =
        this.detailRegAxi.status_perkawinan == "0"
          ? "Single"
          : this.detailRegAxi.status_perkawinan == "1"
          ? "Married"
          : this.detailRegAxi.status_perkawinan == "2"
          ? "Widowed"
          : this.detailRegAxi.status_perkawinan == "3"
          ? "Divorced"
          : this.detailRegAxi.status_perkawinan == "4"
          ? "Separated"
          : "-";
      ...
      //   : "-";
      // data.nama_ibu_kandung = this.detailRegAxi.nama_ibu_kandung
      //   ? this.detailRegAxi.nama_ibu_kandung
      //   : "-";
      data.nama_pasangan = this.detailRegAxi.nama_pasangan;
      this.detailRegAxi.nama_pasangan = this.detailRegAxi.nama_pasangan
        ? this.detailRegAxi.nama_pasangan
        : "-";
      data.no_ktp_pasangan = this.detailRegAxi.no_ktp_pasangan;
      this.detailRegAxi.no_ktp_pasangan = this.detailRegAxi.no_ktp_pasangan
        ? this.detailRegAxi.no_ktp_pasangan
        : "-";

      data.jenis_kelamin =
        this.detailRegAxi.jenis_kelamin == "1" ? "Perempuan" : "Laki-laki";
      data.no_npwp = this.detailRegAxi.no_npwp
        ? this.detailRegAxi.no_npwp
        : "-";

      // data.created_at = this.axi.attributes["created-at"];
      data.nama_bank = this.detailRegAxi ? this.detailRegAxi.nama_bank : "-";
      data.cabang_bank = this.detailRegAxi
        ? this.detailRegAxi.cabang_bank
        : "-";
      data.kota_bank = this.detailRegAxi ? this.detailRegAxi.kota_bank : "-";
      data.an_rekening = this.detailRegAxi
        ? this.detailRegAxi.an_rekening
        : "-";
      data.no_rekening = this.detailRegAxi
        ? this.detailRegAxi.no_rekening
        : "-";
      data.nama_npwp = this.detailRegAxi.nama_npwp;
      data.status_npwp = this.detailRegAxi.tipe_npwp;
      data.pkp = this.detailRegAxi.pkp;
      ...
      data.foto_ktp = this.detailRegAxi.foto_ktp
        ? this.detailRegAxi.foto_ktp
        : "";
      data.foto_selfie = this.detailRegAxi.foto_selfie
        ? this.detailRegAxi.foto_selfie
        : "";
      data.foto_npwp = this.detailRegAxi.foto_npwp
        ? this.detailRegAxi.foto_npwp
        : "";
      data.foto_rekening = this.detailRegAxi.foto_rekening
        ? this.detailRegAxi.foto_rekening
        : "";
      data.bp_number = this.detailRegAxi.bp_number
        ? this.detailRegAxi.bp_number
        : "-";
      data.status_registrasi = this.detailRegAxi.status_registrasi
        ? this.detailRegAxi.status_registrasi
        : "-";
    ...
    async simpanData() {
      ...
      this.jenisKaryawanValue = this.jenisAxiValue !== 3 ? null : this.jenisKaryawanValue;
      this.axiData.axi_id_reff = this.jenisAxiValue === 3 ? null : this.axiData.axi_id_reff;
      this.legalFormValue = this.kategoriAxiValue === '1' ? null : this.legalFormValue;

      if (this.detailRegAxi.jenis_axi != this.jenisAxiValue) {
        
        if (this.detailRegAxi.jenis_axi == 1 && this.jenisAxiValue == 3)
        {
          const newDate = new Date('2999-12-31');
          newDate.setHours(0, 0, 0, 0);
          this.axiData.tanggal_masa_aktif = newDate;
        }
        if (this.detailRegAxi.jenis_axi == 3 && this.jenisAxiValue == 1)
        {
          const today = new Date();
          // Add 13 months
          const futureDate = new Date();
          futureDate.setMonth(today.getMonth() + 13);
          futureDate.setHours(0, 0, 0, 0);
          this.axiData.tanggal_masa_aktif = futureDate;
        }
      } else {
        const existingDate = new Date(this.detailRegAxi.tanggal_masa_aktif);
        existingDate.setHours(0, 0, 0, 0);
        this.axiData.tanggal_masa_aktif = existingDate;
      }
      if (valid) {
        ...
        const payload = {
          jenis_axi: this.jenisAxiValue,
          jenis_karyawan: this.jenisKaryawanValue,
          legal_form: this.legalFormValue,
          no_ktp: this.axiData.no_ktp,
          kota_lahir: this.axiData.kota_lahir,
          tanggal_lahir: this.axiData.tanggal_lahir,
          status_perkawinan: this.statusValue == 0 ? "0" : this.statusValue,
          nama_pasangan: this.axiData.nama_pasangan,
          no_ktp_pasangan: this.axiData.no_ktp_pasangan,
          jenis_kelamin: this.jenisKelaminValue,
          agama: this.agamaValue,
          email: this.axiData.email,
          no_hp: this.axiData.no_hp,
          nama: this.axiData.nama,
          npwp: this.axiData.npwp,
          no_npwp: this.axiData.no_npwp,
          nama_npwp: this.axiData.nama_npwp,
          tipe_npwp: this.kategoriAxiValue,
          pkp: this.axiData.pkp,
          area_id: this.areaValue,
          cabang_daftar: this.cabangValue,
          axi_id_reff: this.axiData.axi_id_reff,
          alamat_ktp: this.axiData.jalan,
          rt: this.axiData.rt,
          rw: this.axiData.rw,
          bank_id: this.bankValue,
          no_rekening: this.axiData.no_rekening,
          an_rekening: this.axiData.an_rekening,
          cabang_bank: this.axiData.cabang_bank,
          kota_bank: this.axiData.kota_bank,
          kelurahan_id: this.kelurahanValue,
          provinsi_id: this.provinsiValue,
          kota_id: this.kotaValue,
          kecamatan_id: this.kecamatanValue,
          agreement: true,
          zipcode: this.axiData.kode_pos,
          alasan: "",
          status_registrasi: "AKTIF",
          tanggal_masa_aktif: new Date(this.axiData.tanggal_masa_aktif),
        };
    ...
    async simpanFoto() {
      ...
      if (
        ...
        const profileId = this.detailRegAxi.profile_id;
        let payload = {
          jenis_axi: this.detailRegAxi.jenis_axi,
          no_ktp: this.axiData.no_ktp,
          kota_lahir: this.axiData.kota_lahir,
          tanggal_lahir: this.axiData.tanggal_lahir,
          status_perkawinan: this.statusValue == 0 ? "0" : this.statusValue,
          ...
          no_npwp: this.axiData.no_npwp,
          nama_npwp: this.axiData.nama_npwp,
          tipe_npwp: this.detailRegAxi.tipe_npwp,
          pkp: this.axiData.pkp,
          area_id: this.areaValue,
          cabang_daftar: this.cabangValue,
          axi_id_reff: this.axiData.axi_id_reff,
          ...
          alasan: "",
          status_registrasi: "AKTIF",
          foto_ktp: this.tmpKtp,
          foto_rekening: this.tmpBuku,
          foto_npwp: this.tmpNpwp
          // foto_selfie: this.tmpAvatar,
        };
        ...
        try {
          await Promise.all([
            this.updateDataDetail({ payload, profileId })
          ...
          swal(
            ...
            error.response.status == 413
              ? "Gagal mengganti foto, ukuran file teralu besar. (maks 5MB)"
    ...
    resetPass() {
      ...
      swal({
        ...
        if (result.value) {
          ...
          // console.log(this.axiData.nomor_axi_id);
          let res = await that.newResetPassword(this.axiData.nomor_axi_id);
          // console.log(res);

          if (res.data.status == "success") {
            that.showModalLoading = false;
            swal.fire(res.data.detail, "", "success");
          } else {
            that.showModalLoading = false;
            swal.fire("Terjadi Kendala teknis", "", "error");
          }
        }
      });
    },
