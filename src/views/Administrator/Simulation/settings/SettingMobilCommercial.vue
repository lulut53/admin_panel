        ...
        <base-header class="pb-6" type="">
            <div class="row align-items-center py-4">
                <div class="col-lg-8 col-7">
                    <h6 class="h2 d-inline-block mb-0">Setting Simulasi - Mobil Commercial</h6>
            ...
            <div class="card card-child">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                <select class="form-control" v-model="dokumen.mobil">
                                    <option v-for="(d, i) in versi_dokumen_mobil" :key="i" :value="d.id"> {{ d.attributes.nama }} </option>
                                </select>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                <select class="form-control" v-model="dokumen.lending">
                                    <option v-for="(d, i) in versi_dokumen_lending" :key="i" :value="d.id"> {{ d.attributes.nama }} </option>
                                </select>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                <select class="form-control" v-model="dokumen.premi">
                                    <option v-for="(d, i) in versi_dokumen_premi" :key="i" :value="d.id"> {{
                                        d.attributes.nama }}
                                    </option>
                                </select>
                            </div>
...
export default {
    ...
    async mounted() {
        try {
            ...
            let config_car = await this.$api.get(`${this.$store.state.bff_base_url}/simulasi/config/1/commercial`,
                {
                    'headers': {
                        // 'Accept': 'application/vnd.api+json',
                        'Authorization': `Bearer ${token}`
    ...
    methods: {
        async saveConfig(type) {
            ...
            if (type == 'car') {
                ...
                await this.makeDocumentActiveBySubJenisDoc(this.dokumen.mobil)
                ...
                let res = await this.$api.put(`${this.$store.state.bff_base_url}/simulasi/config/1/commercial`, data,
                    {
                        'headers': {
                            // 'Accept': 'application/vnd.api+json',
                            'Authorization': `Bearer ${token}`
        ...
        async getVersiDokumen(id) {
            try {
                ...
                let res;
                if (id === 1) {
                    res = await this.$api.get(`${this.$store.state.simulation_base_url}/versidokumen/?jenis_dokumen=1&sub_jenis_dokumen=2&sort_by=id:desc&offset=10000`,
                        {
                            'headers': {
                                'Accept': 'application/vnd.api+json',
                                'Authorization': `Bearer ${token}`
