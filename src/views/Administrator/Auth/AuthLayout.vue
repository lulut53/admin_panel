<template>
  <div class="bg-login vh-100 vw-100">
    <!-- <base-nav
      v-model="showMenu"
      type="light"
      :transparent="true"
        ...
        <div class="row align-items-center justify-content-xl-between">
          <div class="col-xl-6">
            <div class="copyright text-center text-xl-left text-muted">
              © 2019 <a href="https://dicicilaja.com" class="font-weight-bold ml-1" target="_blank"  rel="noopener">dicicilaja.com</a>
            </div>
          </div>
          <div class="col-xl-6">
            <ul class="nav nav-footer justify-content-center justify-content-xl-end">
              <li class="nav-item">
                <p class="nav-link">Made With &heartsuit;</p>  
              </li>
              <!-- <li class="nav-item">
