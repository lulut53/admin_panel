    ...
    <base-header class="pb-6" type="">
      <div class="row align-items-center py-4">
        <div class="col-lg-6 col-8">
          <h6 class="h2 d-inline-block mb-0">Detail MAXI</h6>
          <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
            <ol class="breadcrumb breadcrumb-links">
              ...
              <li class="breadcrumb-item"><router-link to="/administrator/maxi/list">MAXI</router-link></li>
                ...
                <div key="2" v-if="isShow">
                  <el-table :data="item"
                    ...
                    <el-table-column label="Kategori"
                                      ...
                                      width="150">
                      <template v-slot="{row}">
                        {{ getIncludedSubProduk('products', row.relationships.produk.data, 'nama') }}
                      </template>
                    </el-table-column>
                    ...
                    <el-table-column label="Status"
                                      ...
                                      width="130">
                      <template v-slot="{row}">
                            {{ row.attributes.status_id == 10 ? 'Disetujui' : row.attributes.status_id == 11 ? 'Tidak disetujui' : 'Belum disetujui' }}
                      </template>
                    </el-table-column>
                    <el-table-column prop="id" min-width="130px" label="Aksi">
                      <template v-slot="{row}">
                        <router-link :to="{ name: `detail_${getIncludedSubProduk('products', row.relationships.produk.data, 'nama').replace(/\s+/g, '').toLowerCase()}`, params: { id: row.id }}">
              ...
              <div class="row mb-4">
                ...
                <div class="col-md-8">
                  <ValidationProvider
                    ...
                    <el-input v-model="tempNpwp.attributes.nomor" maxlength="15" />
                    <span class="error">{{ errors[0] }}</span>
                  </ValidationProvider>
                </div>
              </div>
              ...
              <div class="row mb-4">
                ...
                <div class="col-md-8">
                  <ValidationProvider
                    ...
                    v-slot="{ errors, failedRules}"
                    name="Nomor Telepon">
                    <el-input v-model="tempProfile.attributes.no_telp" maxlength="16" />

                    <span class="text-danger" v-if="failedRules.regex">Format No. Telepon salah (Contoh: 02155001333)</span>
              ...
              <div class="row mb-4">
                ...
                <div class="col-md-8">
                  <ValidationProvider
                    ...
                    <el-input v-model="tempProfile.attributes.no_hp" maxlength="16" />
              ...
              <div class="row mb-4">
                ...
                <div class="col-md-8">
                  <ValidationProvider name="KTP" rules="required|numeric|length:16" v-slot="{ errors }">
                    <el-input v-model="tempProfile.attributes.no_ktp" maxlength="16" />
                    <span class="error">{{ errors[0] }}</span>
                  </ValidationProvider>
                </div>
              </div>
        ...
        <div key="1" v-if="!isModalProcess">
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-md-8">
                <file-input @change="profilePhotoChange" accept=".jpg, .jpeg, .png, .JPG, .JPEG, .PNG"/>
              </div>
            </div>
            <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-md-8">
                <file-input @change="ktpPhotoChange" accept=".jpg, .jpeg, .png, .JPG, .JPEG, .PNG"/>
              </div>
            </div>
            <div class="row">
              <label class="col-md-4 col-form-label form-control-label"></label>
            ...
            <div class="row">
              ...
              <div class="col-md-8">
                <file-input @change="npwpPhotoChange" accept=".jpg, .jpeg, .png, .JPG, .JPEG, .PNG"/>
              </div>
            </div>
            <div class="row">
              <label class="col-md-4 col-form-label form-control-label"></label>
  ...
  methods: {
    ...
    onChangeKecamatan() {
      ...
      try {
        await Promise.all([
          ...
          this.getProduks(),
          this.getUser(this.included.find(x => x.type == "profiles").relationships.user.data.id),
        ])

        if (this.maxi.attributes.status_id != 14) {
          this.$router.push('/administrator/maxi/list')
        } else {
          ...
          this.tempProduk = this.included.find(x => x.id == this.maxi.relationships.products.data[0].id && x.type == "products")
          this.maxiData = this.packData();
          this.item = this.sub_produk;
    ...
    async simpanData() {
      ...
      if (valid) {
        ...
        if (payloadUser) payloadUser.attributes.email = this.tempProfile.attributes.email
