    ...
    <base-header class="pb-6" type="">
      <div class="row align-items-center py-4">
        <div class="col-lg-8 col-8">
          <h6 class="h2 d-inline-block mb-0">Detail Produk Saya</h6>
    ...
    <div class="container-fluid mt--6 small">
      <card>
        <div class="row">
          ...
          <div class="col-6 pb-3 text-right" v-if="isShow">
        ...
        <div key="1" v-if="!isModalProcess">  
          ...
          <div class="form-group">
            <div class="row mt-2 mb-4">
              ...
              <div class="col-md-8">
                <file-input @change="brosurChange"/>
              </div>
            </div>
            <!-- <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-md-8">
                <file-input @change="productPhotoChange"/>
              </div>
            </div>
            <div class="row">
              <label class="col-md-4 col-form-label form-control-label"></label>
              <div class="col-md-8 mt-2 mb-4">
                <img :src="productPreview" v-if="productPreview" alt="" width="200px">
              </div>
            </div>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    async editModal() {
      ...
      await this.getTagByProduk(this.subproduk.attributes.produk_id)
    ...
    async simpanFoto() {
      ...
      if (this.tmpBrosur == "" && this.tmpProduct == "") {
        ...
        if (res.name == 'Error') {
          swal("Gagal", "Gagal mengganti foto / brosur", "error")
          .then(function () {
            // that.getData()
          })
        } else {
