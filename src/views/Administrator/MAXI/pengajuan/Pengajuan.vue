    ...
    <base-header class="pb-6" type="">
      <div class="row align-items-center py-4">
        <div class="col-lg-6 col-7">
          <h6 class="h2 d-inline-block mb-0">Pengajuan Produk</h6>
          <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
            <ol class="breadcrumb breadcrumb-links">
              ...
              <li class="breadcrumb-item active" aria-current="page">Pengajuan Produk</li>
            </ol>
          </nav>
        </div>
        <div class="col-lg-6 pt-2 text-right" v-if="isShow && !isError">
          ...
          <!-- <base-button type="success" @click="modalBuatPengajuan = true">
            <i class="fa fa-plus"></i>
            <span class="hidden-sm-down">Buat Pengajuan</span>
          </base-button> -->
          ...
          <!-- <base-button class="btn btn-xl" type="secondary">
              ...
              <div>
                ...
                <el-table :data="item"
                  ...
                  <el-table-column label="Nama Produk"
                                ...
                                sortable="custom">
                    <template v-slot="{row}">
                      <router-link :to="{ name: 'details_maxipengajuan', params: { id: row.id }}">{{row.attributes.nama}}</router-link>
                    </template>
                  </el-table-column>
