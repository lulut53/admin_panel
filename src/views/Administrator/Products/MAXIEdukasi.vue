    ...
    <base-header class="pb-6" type="">
      <div class="row align-items-center py-4">
        <div class="col-lg-6 col-7">
          <h6 class="h2 d-inline-block mb-0">MAXI Edukasi</h6>
          <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
            <ol class="breadcrumb breadcrumb-links">
              ...
              <li class="breadcrumb-item" aria-current="page">MAXI Edukasi</li>
            </ol>
          </nav>
        </div>
              ...
              <div>
                ...
                <el-table :data="item"
                  ...
                  <el-table-column label="Nama Produk"
                                ...
                                sortable="custom">
                    <template v-slot="{row}">
                      <router-link :to="{ name: 'detail_maxiedukasi', params: { id: row.id }}">{{row.attributes.nama}}</router-link>
