    ...
    <base-header class="pb-6" type="">
      <div class="row align-items-center py-4">
        <div class="col-lg-12 col-7">
          <h6 class="h2 d-inline-block mb-0">Perbaharui Halaman Produk Pembiayaan</h6>
            ...
            <div class="card-body">
              <transition name="fade" mode="out-in">
                ...
                <div key="2" v-if="isShow">
                  ...
                  <div class="row">
                    <new-banner-single
                      :title="'Banner Produk Pembiayaan'"
                      :val="fileSingle"
  ...
  export default {
    ...
    methods: {
      ...
      async getData() {
        ...
        let res = JSON.parse(JSON.stringify(await this.getDetailHalaman(3)));
        if (res.name != 'Error') {
