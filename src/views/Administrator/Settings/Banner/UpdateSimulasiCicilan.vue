    ...
    <base-header class="pb-6" type="">
      <div class="row align-items-center py-4">
        <div class="col-lg-12 col-7">
          <h6 class="h2 d-inline-block mb-0">Perbaharui Halaman Simulasi Cicilan</h6>
  ...
  export default {
    ...
    methods: {
      ...
      async getData() {
        ...
        let res = JSON.parse(JSON.stringify(await this.getDetailHalaman(4)));
        if (res.name != 'Error') {
