    ...
    <base-header class="pb-6" type="">
      <div class="row align-items-center py-4">
        <div class="col-lg-12 col-7">
          <h6 class="h2 d-inline-block mb-0">Perbaharui Halaman Profil</h6>
          <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
            <ol class="breadcrumb breadcrumb-links">
              ...
              <li class="breadcrumb-item">Change Banner</li>
            </ol>
          </nav>
          <div class="pt-2">
                  ...
                  <template>
                    <form action="">
                      ...
                      <div class="row">
                        ...
                        <new-banner-double
                          :title="'Parallax Profil'"
                          :val="fileSingle2"
                          :fileSingle="fileSingle2"
                          @getData="getData"
                          @showModalProcess="emitModalProcess"/>
                      </div>
                      <hr class="diver mt-0">
...
<script>
  ...
  import NewBannerDouble from '@/components/Inputs/NewBannerDouble'
  ...
  export default {
    ...
    methods: {
      ...
      async getData() {
        ...
        let res = JSON.parse(JSON.stringify(await this.getDetailHalaman(2)));
        if (res.name != 'Error') {
          ...
          this.fileSingle2 = res.included[1]
      ...
      async updateHalaman() {
        ...
        if (this.fileSingle) payload.image_banner = this.fileSingle[0]
        if (this.fileSingle2) payload.image_parallax = this.fileSingle2[0]

        let res = await this.updateBannerProfile(payload)
        if (res.name == "Error") {
