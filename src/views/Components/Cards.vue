      ...
      <div class="row card-wrapper">
            ...
            <div class="row justify-content-center">
              <div class="col-lg-3 order-lg-2">
                <div class="card-profile-image">
                  <a href="#">
                    <img src="img/theme/team-4.jpg" class="rounded-circle" alt = "">
                  </a>
                </div>
              </div>
            </div>
        ...
        <div class="col-lg-4">
          ...
          <card>
            <!-- Card body -->
            <a href="#!">
              <img src="img/theme/team-1.jpg"
                   class="rounded-circle img-center img-fluid shadow shadow-lg--hover" style="width: 140px;" alt = "">
            </a>
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <p class="card-text mt-4">Argon is a great free UI package based on Bootstrap 4 that includes the most
